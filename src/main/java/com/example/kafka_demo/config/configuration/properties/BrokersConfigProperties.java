...
public record BrokersConfigProperties(String topicName, int numberOfPartitions, short replicationFactor, String hostName, Long loadSize, short concurrency, boolean truncateOnStartup) {
