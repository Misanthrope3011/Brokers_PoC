...
public record BrokersConfigProperties(String topicName, int numberOfPartitions, short replicationFactor, String hostName, Long loadSize, String concurrency) {
